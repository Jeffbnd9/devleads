  ...
  return (
    <>
      <div className="pt-24 px-4 max-w-4xl mx-auto">
        <h1 className="text-5xl text-center font-bold">Conditions générales d'utilisation (CGU)</h1>

        {/* Objet */}
        <section className="mt-10">
          <h2 className="text-3xl font-bold mb-4">Objet</h2>
          <p>
            Les présentes conditions ont pour objet de définir les modalités d'accès et d'utilisation du site
            exploité par <strong>DevLeads</strong>. Le site a pour but de présenter l'entreprise, ses services et
        ...
        <section className="mt-8">
          ...
          <p>
            Le site est accessible gratuitement, 7j/7 et 24h/24, sous réserve d'interruptions pour maintenance,
            mise à jour ou cas de force majeure. DevLeads s'efforce d'assurer l'accessibilité, sans y être tenue
        ...
        <section className="mt-8">
          ...
          <p>
            L'utilisateur s'engage à ne pas perturber le bon fonctionnement du site, à ne pas tenter d'accéder à
            des zones non autorisées, ni à introduire de contenu malveillant (virus, scripts, spam, etc.). Tout
            usage contraire aux lois et règlements en vigueur est interdit.
          </p>
        </section>
        ...
        <section className="mt-8">
          ...
          <p>
            ...
            <a className="underline" href="/conf">Politique de confidentialité</a> et le bandeau de consentement.
          </p>
        </section>
        ...
        <section className="mt-8 mb-16">
          ...
          <p>
            ...
            les tribunaux d'<strong>Evreux</strong> seront seuls compétents.
          </p>
        </section>
      </div>
    </>
