      ...
      <div className="pt-24 px-4 max-w-4xl mx-auto">
        ...
        <section className="mt-10">
          ...
          <ul className="list-disc ml-6 space-y-1">
            ...
            <li>Email&nbsp;: <a className="underline" href="mailto:contact@devleads.org">contact@devleads.org</a></li>
            <li>Site&nbsp;: <a className="underline" href="https://www.devleads.org">www.devleads.org</a></li>
            {/* Optionnel selon ta situation fiscale */}
            {/* <li>TVA intracommunautaire : non applicable (franchise en base)</li> */}
          </ul>
        </section>
        ...
        <section className="mt-8">
          ...
          <ul className="list-disc ml-6 space-y-1">
            ...
            <li>Site&nbsp;: <a className="underline" href="https://vercel.com">vercel.com</a></li>
          </ul>
        ...
        <section className="mt-8 mb-16">
          ...
          <p>
            ...
            pouvons garantir l'exhaustivité ni l'actualisation permanente des contenus publiés. L'utilisation du
            site se fait sous la seule responsabilité de l'utilisateur. DevLeads ne pourra être tenue responsable
            des dommages directs ou indirects résultant de l'accès ou de l'usage du site (y compris l'inaccessibilité,
            pertes de données, présence de virus, etc.).
          </p>
        </section>
      </div>
    </>
